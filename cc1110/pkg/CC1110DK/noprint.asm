...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'printinit'
;------------------------------------------------------------
;	noprint.c:6: printinit()
;	-----------------------------------------
;	 function printinit
;	-----------------------------------------
_printinit:
...
;------------------------------------------------------------
;c                         Allocated with name '_putchar_c_1_46'
;------------------------------------------------------------
;	noprint.c:11: putchar(char c)
;	-----------------------------------------
;	 function putchar
;	-----------------------------------------
_putchar:
